...
HD_PWD='C:/Users/exone/Documents/GitHub/Hardware-Engineering-Lab/Vivado projects/project_BCD_to_7_segment_display/project_BCD_to_7_segment_display.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_TO_7_segment_Decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCD_TO_7_segment_Decoder.tcl
